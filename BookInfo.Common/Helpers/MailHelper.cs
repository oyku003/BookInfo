...
namespace BookInfo.Common.Helpers
{
    public class MailHelper
    {
        ...
        public static bool SendMail(string body, List<string> to, string subject, bool isHtml = true)
        {
            ...
            try
            {
                ...
                message.From = new MailAddress(ConfigHelper.Get<string>("MailUser")); //Webconfig'de key'i MailUser olanın Value'sunu getir.
                    ...
                    ConfigHelper.Get<int>("MailPort")))
                {
                    ...
                    smtp.Credentials = new 
                        NetworkCredential(ConfigHelper.Get<string>("MailUser"),
